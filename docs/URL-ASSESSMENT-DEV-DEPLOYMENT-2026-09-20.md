...
- The CloudWatch filter matched all ten synthetic operational-failure reasons and excluded known-threat, invalid-input and no-match events. This validates metric matching, not an alarm-delivery transition. The shared email subscription was already confirmed; no new recipient/subscription was created.
